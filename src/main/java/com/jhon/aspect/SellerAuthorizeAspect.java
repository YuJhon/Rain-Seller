 ...
 * @author jiangy19
 * @version v1.0
 * @FileName SellerAuthorizeAspect
...
public class SellerAuthorizeAspect {
    ...
    /*
    @Pointcut("execution(public * com.jhon.controller.Seller*.*(..))" +
    "&& !execution(public * com.jhon.controller.SellerUserController.*(..))")
    public void verify() {}
